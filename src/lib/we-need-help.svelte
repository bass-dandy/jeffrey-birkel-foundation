...
<section>
	<ContentContainer>
		...
		<p>
			Jeff encouraged his two boys, Matt and Mike, to take up running at a young age - and they did! They both ran Boston in 2023, and on Father’s Day of 2024 they decided they'd like to try to run it again with Jeff - one of them pushing him in a racing pushchair and the other running alongside. The Boston Marathon requires setting an acceptable qualifying time at another marathon to get an entry, and they did just that at the Nebraska State Fair Marathon on August 24th!
		</p>
	</ContentContainer>
</section>
...
<style>
	section {
		...
		background:
			...
			url('/images/r2r-2x.jpg');
		background:
			linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)),
			image-set(
				url('/images/r2r-1x.jpg') 1x,
				url('/images/r2r-2x.jpg') 2x,
				url('/images/r2r-3x.jpg') 3x,
				url('/images/r2r-4x.jpg') 4x
			);
